...
namespace DA_STOREBOOKS_WIN
{
    public partial class frmHoaDon : Form 
    {
        ...
        public string connectionString = "Data Source=QUANGCUONG\\SQLEXPRESS;Initial Catalog=DA_QLSACH;User ID=sa;Password=123;Integrated Security=False;";
        ...
        public void HienThiDSKhachHang()
        {
            ...
            {
                MessageBox.Show("Lỗi hiển thị khách hàng lên combobox => Chi tiết: " + ex.Message, "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
        }
        ...
        private int LayMaNhanVienTheoTen(string tenNV)
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                try
                {
                    ...
                    {
                        MessageBox.Show("Không tìm thấy nhân viên có tên này trong cơ sở dữ liệu.");
                    }
                }
                catch (Exception ex)
                {
                    MessageBox.Show("Lỗi tìm nhân viên theo mã:\n " + ex.Message, "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                }
            }
        ...
        private int LayMaKhachHangTheoTen(string tenKH)
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                {
                    MessageBox.Show("Lỗi tìm khách hàng trong cơ sở dữ liệu:\n " + ex.Message, "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                }
            }
        ...
        private int LaySoLuongTonKho(int maSach)
        {
            ...
            {
                MessageBox.Show("Lỗi khi lấy số lượng tồn kho: " + ex.Message, "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
        ...
        //FROM XỬ LÝ HÓA ĐƠN PHẦN LƯU VÀ IN
        private void btn_Luu_Click(object sender, EventArgs e)
        {
            ...
            int trangThai = 1;
            // Hiển thị hộp thoại xác nhận
            DialogResult result = MessageBox.Show($"Bạn có chắc muốn lưu hóa đơn có mã {maHD} và tất cả chi tiết của nó?", "Xác nhận lưu", MessageBoxButtons.OKCancel, MessageBoxIcon.Warning);
        ...
        private void btn_Tim_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Vui lòng điền thông tin hóa đơn cần tìm.", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
            //LẤY DỮ LIỆU
